...
function applyCape(ctx) {
    // let image = new Image()
    // image.crossOrigin = "anonymous";
    // image.src = '/enchanted_glint_entity.png'
    // image.onload = function() {
    //     console.log(ctx)
    //     //source
    //     let sourceX = 0;
    //     let sourceY = 0;
    //     ctx.drawImage(image, sourceX, sourceY, 22, 17, 0, 0, 22, 17);
    ...
    //     capeMesh.material = new THREE.MeshStandardMaterial({ map: texture, transparent: true })
    // }
    //CAUSTIC SHADER?
