...
class MinecraftSkinViewer {
    ...
    setupModel() {
        ...
        uvAttribute.setXY(0, 1 / 64, 16 / 32 );
        uvAttribute.setXY(1, 10 / 64, 16 / 32 );
        uvAttribute.setXY(2, 1 / 64, 1 / 32 );
        uvAttribute.setXY(3, 10 / 64, 16 / 32 );
        uvAttribute.setXY(4, 10 / 64, 1 / 32 );
        uvAttribute.setXY(5, 1 / 64, 1 / 32 );
