...
export class PlayerObject {
    ...
    setSlim(slim) {
        this.group.remove(
            this.group.getObjectByName('Skin'),
            this.group.getObjectByName('Overlay')
        )
...
class SkinObject extends PlayerPart {
    ...
    generateMesh(slim) {
        ...
        const skinMesh = new Mesh(
            BufferGeometryUtils.mergeGeometries(skinGeometry),
            this.material
        )
        skinMesh.name = 'Skin'
...
class OverlayObject extends PlayerPart {
    ...
    generateMesh(slim) {
        ...
        const overlayMesh = new Mesh(
            BufferGeometryUtils.mergeGeometries(overlayGeometry),
            this.material
        )
